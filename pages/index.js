          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <Link href="/">
                  <a href="https://api.whatsapp.com/send?phone=5594991176136&text=Contato%20do%20Site%20Osvaldo%20Lopes%20Advocacia%20-%20Como%20podemos%20ajudar" className="font-bold text-gray-800 mt-8">
            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src={require("assets/img/team-1-800x800.jpeg")}
